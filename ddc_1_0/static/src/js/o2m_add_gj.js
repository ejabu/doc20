...
odoo.define('web.ListView2', function(require) {
    'use strict';
    ...
    var form_relational = require('web.form_relational');
    console.log(form_relational);
    console.log(form_relational.X2ManyList);
    //
    var base = ListView.List.prototype.pad_table_to;
    console.log(base);

    var X2ManyList = ListView.List.include({
        pad_table_to: function(count) {
            console.log('EJA PAD 2');
            // this._super(0);


            if (this.view.x2m) {
                console.log(this.view.x2m.options);
                ...
                // this._super(3);
                // this.$current.find('td:oe_form_field_x2many_list_row_add').remove()
                // var self = this;
                ...
                var $padding = this.$current.find('tr');
                var $newrow = $('<tr>').append($cell);
                    console.log($padding.length);
                if ($padding.length) {
                    console.log('kalo belom 4');
                    console.log($padding);
                    // $padding.remove();
                    $padding.prev().css({"color": "red", "border": "2px solid red"});
                } else {
                    console.log('kalo udah 4');
